...
public class fr_Login extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(input_pass, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(110, 110, 110)
    ...
    private void btn_singupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_singupActionPerformed
        if(Chat_client.fr_reg != null){
            Chat_client.fr_reg = new fr_reg();
            Chat_client.fr_reg.setVisible(true);
        }else
            Chat_client.fr_reg.setVisible(true);
    ...
    public static javax.swing.JTextField input_pass;
